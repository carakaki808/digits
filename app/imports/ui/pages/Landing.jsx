...
class Landing extends React.Component {
  render() {
    return (
      <div className='cover-photo-digits'>
        <Grid container centered stackable columns={3}>
          <Grid.Column textAlign='center'>
            ...
            <Icon name='calendar check outline' inverted size='huge'/>
            <Header as='h1' inverted>Timestamped Notes</Header>
            <Header as='h3' inverted>Each time you make contact, you can write a note that summarizes the conversation. This note is saved along with a timestamp with the contact.</Header>
          </Grid.Column>
        </Grid>
      </div>
    );
